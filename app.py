...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Đức Toàn - Trường Tiểu học Minh Quang - ĐT: 0845 756 524</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Đức Toàn - Trường Tiểu học Minh Quang - ĐT: 0845 756 524 </div>", unsafe_allow_html=True)
